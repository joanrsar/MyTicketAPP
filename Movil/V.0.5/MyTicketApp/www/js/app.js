...
var app = angular.module('starter', ['ionic','starter.controllers',
                                    ...
                                    'starter.pagoControl',
                                    'starter.tiquetesControl',
                                    'starter.tiquetesFactoria',
                                    'starter.tiqueteDetalleControl'])
...
//------------------------------------------------------------
 ...
 .state('app.evento', {
  ...
  .state('app.tiquetes', {
    ...
    views: {
      'menuContent': {
        templateUrl: 'templates/tiquetes.html'
      }
    }
  })

  .state('app.tiquete', {
      url: '/tiquete/:idTiquete',
      views: {
        'menuContent': {
          templateUrl: 'templates/tiqueteDetalle.html',
          controller: 'tiqueteDetalleControl'
        }
      }
    })
